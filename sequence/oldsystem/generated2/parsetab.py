...
_lr_productions = [
  ...
  ('program -> statement','program',1,'p_programme_statement','parser_prog.py',10),
  ('program -> statement program','program',2,'p_programme_recursif','parser_prog.py',15),
  ('statement -> for','statement',1,'p_statement','parser_prog.py',20),
  ('statement -> expression ;','statement',2,'p_statement','parser_prog.py',21),
  ('statement -> function','statement',1,'p_statement','parser_prog.py',22),
  ('function -> FUNCTION VAR ( param ) { program }','function',8,'p_function','parser_prog.py',27),
  ('param -> VAR','param',1,'p_param','parser_prog.py',32),
  ('param -> VAR , param','param',3,'p_param','parser_prog.py',33),
  ('param -> <empty>','param',0,'p_param','parser_prog.py',34),
  ('use_function -> VAR ( call_data )','use_function',4,'p_use_function','parser_prog.py',44),
  ('call_data -> number','call_data',1,'p_call_data','parser_prog.py',49),
  ('call_data -> number , call_data','call_data',3,'p_call_data','parser_prog.py',50),
  ('call_data -> <empty>','call_data',0,'p_call_data','parser_prog.py',51),
  ('assign -> VAR = number','assign',3,'p_assign','parser_prog.py',61),
  ('for -> FOR ( assign ; eval ; assign ) { program }','for',11,'p_for','parser_prog.py',66),
  ('expression -> section','expression',1,'p_expression','parser_prog.py',71),
  ('expression -> pause','expression',1,'p_expression','parser_prog.py',72),
  ('expression -> use_function','expression',1,'p_expression','parser_prog.py',73),
  ('expression -> assign','expression',1,'p_expression','parser_prog.py',74),
  ('calc -> data OPP data','calc',3,'p_calc','parser_prog.py',79),
  ('eval -> data EVAL_OP data','eval',3,'p_eval','parser_prog.py',84),
  ('number -> data','number',1,'p_number','parser_prog.py',89),
  ('number -> calc','number',1,'p_number','parser_prog.py',90),
  ('data -> NUMBER','data',1,'p_data','parser_prog.py',95),
  ('data -> VAR','data',1,'p_data','parser_prog.py',96),
  ('section -> CUBE number','section',2,'p_section_cube','parser_prog.py',101),
  ('section -> FACE number number','section',3,'p_section_face','parser_prog.py',106),
  ('section -> SQUARE number number number','section',4,'p_section_square','parser_prog.py',111),
  ('section -> LEDSTRIP number number number number','section',5,'p_section_ledstrip','parser_prog.py',116),
  ('section -> LED number number number number number','section',6,'p_section_led','parser_prog.py',121),
  ('pause -> DELAY number','pause',2,'p_pause','parser_prog.py',126),
]
